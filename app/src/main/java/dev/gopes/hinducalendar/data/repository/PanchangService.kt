...
class PanchangService @Inject constructor(
    ...
    override fun computePanchang(
        ...
        return try {
            computePanchangInternal(date, location, tradition, key)
        } catch (e: Exception) {
            Timber.e(e, "Failed to compute panchang for $date")
            null
        }
    }

    private fun computePanchangInternal(
        date: LocalDate,
        location: HinduLocation,
        tradition: CalendarTradition,
        key: CacheKey
    ...
    override fun computeFestivals(
        ...
        return computePanchang(date, refLocation, tradition)?.festivals ?: emptyList()
    }
    ...
    override fun computeMonthlyPanchang(
        ...
        return (1..yearMonth.lengthOfMonth()).mapNotNull { day ->
